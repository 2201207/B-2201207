...
String[] name = new String[] {"홍길동", "이재명", "윤석열", "경복대", "오세훈","강민성","김진성"
,"니키타","김정은","김시온"};
String[] hakbun = {"2501002", "2501004", "2501005","2501014","2591924",
        "2501032", "2501044", "2501055","2501064","2591974"};
...
while (i < name.length) {
    ...
    if ((kor[i] >= 0 && kor[i] <= 100) && (eng[i] >= 0 && eng[i] <= 100) &&
             (math[i] >= 0 && math[i] <= 100)){
    i++;
    } else {
